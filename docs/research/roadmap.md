...
- [ ] **P29 — Trang/chế độ SAU CƯỚI (lời cảm ơn + album phóng sự)**
...
- [ ] **P30 — Chế độ 'Save the Date' (thiệp báo trước)**
...
- [ ] **P31 — Xuất/In thiệp & danh sách (PDF) cho người lớn tuổi thích bản giấy**
...
- [ ] **P32 — Truy cập (a11y) & hiệu năng (WCAG AA contrast, lang, Core Web Vitals)**
