...
- [ ] **P19 — Checklist/timeline chuẩn bị cưới cho CẶP ĐÔI** *(ưu tiên CAO NHẤT)*
...
- [ ] **P20 — Số hoá nghi lễ trước cưới VN (dạm ngõ/ăn hỏi/nạp tài/đón dâu)** *(KHÁC BIỆT NHẤT)*
...
- [ ] **P21 — Trang Story / Hành trình tình yêu dạng timeline (mốc kỷ niệm)**
...
- [ ] **P22 — Tối ưu chia sẻ MXH (Open Graph preview đẹp khi gửi Zalo/FB/Messenger)**
...
- [ ] **P23 — PDPL/Nghị định 356/2025: consent thu thập dữ liệu khách** *(PHÁP LÝ — cần sớm)*
