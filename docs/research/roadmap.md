...
- [ ] **P26 — AI hỗ trợ soạn nội dung (lời mời/lời cảm ơn/chuyện tình yêu)**
  ...
  - HOÃN (2026-06-22): chưa triển khai vì cần API key LLM bên thứ ba (chi phí + làm test phụ thuộc mạng) +
    nghĩa vụ chuyển dữ liệu xuyên biên giới. Khi có credentials/ngân sách + consent xuyên biên giới sẽ làm.
    (Phương án thay thế không cần API: thư viện gợi ý lời mời/lời chúc MẪU cho cặp đôi chọn — có thể cân nhắc.)
