...
- [x] **P33 — Giờ hoàng đạo theo ngày (mở rộng Kim Lâu)** *(làm 2026-06-22)*
  - Đã làm: /xem-ngay có khối "Giờ hoàng đạo trong ngày" — chọn ngày → Can Chi ngày + 6 khung giờ hoàng đạo (kèm khoảng giờ).
    Thêm canChiDay()/hoangDaoHours() vào lunar.js.
  - XÁC MINH: thuật toán Can-Chi ngày + bảng giờ hoàng đạo CẢ 6 cặp Chi đối chiếu lịch vạn niên (quantrimang, baonghean,
    anninhthudo) — khớp 100%; có unit test (test/lunar.test.js, 6 ngày/6 Chi).
  - Lý do: báo lớn đăng hằng ngày "giờ hoàng đạo"; cặp đôi chọn giờ đẹp đón dâu/làm lễ.
  - HOÃN phần "hướng xuất hành" (Hỷ Thần/Tài Thần theo Can ngày): bảng KHÔNG nhất quán giữa nguồn (vd ngày Đinh:
    nguồn nói Hỷ Thần Đông Nam ≠ bảng chuẩn Nam) → cần xác minh kỹ hơn trước khi làm.
