...
- [ ] **P24 — Thêm mẫu thiệp / chủ đề thiết kế** *(ưu tiên CAO NHẤT)*
...
- [ ] **P25 — Hỗ trợ nhiều sự kiện/nhiều ngày (ăn hỏi + tiệc cưới + tiệc nhà gái)** *(rủi ro pháp lý thấp)*
...
- [ ] **P27 — Check-in khách tại tiệc bằng QR (mỗi khách 1 QR → điểm danh + tra bàn)**
